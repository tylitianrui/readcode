...
| 更改instance标签前   | 更改instance标签后    | 说明 |
| :-----| :---- | :---- | 
| ![pre_relabel_instance.png](src/pre_relabel_instance.png "pre_relabel_instance.png") | ![post_relabel_instance.png](src/post_relabel_instance.png "post_relabel_instance.png")  |标签`instance`默认值是标签`__address__`的值，即`localhost:9090`；本次将标签`instance`值更改为`tyltr` |
